...
function index() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/users/ozodbek05")
      .then((data) => data.json())
      .then((result) => {
        setProfil(result);
      });
              ...
              <div className="information">
                ...
                <ul className="mx-3 prof-list">
                  ...
                  <li className="prof-list-item">
                    <a href="https://t.me/supreme_rich">{profil.blog}</a>
                  </li>
                </ul>
              </div>
            </div>
...
//       useEffect(() => {
//             fetch('https://api.github.com/users/ozodbek05').then((db) => db.json()).then((res) => {
//                   setAccount(res)
//             })
